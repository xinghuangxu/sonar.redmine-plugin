...
#
class TestExecutionController < ApplicationController
  before_filter :init_resource_for_user_role

  helper ProjectHelper, DashboardHelper, IssuesHelper  #three helpers classes available for access

  SECTION=Navigation::SECTION_RESOURCE

  def measures
    @metric = select_metric(params[:metric], 'ncloc')  # get the metric
