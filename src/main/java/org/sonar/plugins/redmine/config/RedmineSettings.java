...
public class RedmineSettings implements BatchExtension, ServerExtension {
	...
	public static final String REF_NAME="sonar.redmine.refname";
	public static final String BCREF = "sonar.redmine.bcref";
	...
	public boolean getBcref(){
		return settings.getBoolean(BCREF);
	}
